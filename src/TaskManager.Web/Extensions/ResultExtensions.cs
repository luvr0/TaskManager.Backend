...
public static class ResultExtensions
{
  ...
  /// <summary>
  /// Maps Result to TypedResults for endpoints that return Ok, ValidationProblem, or ProblemHttpResult (without NotFound)
  /// </summary>
  ...
  /// <summary>
  /// Maps Result to TypedResults for endpoints that return Ok, ValidationProblem, NotFound, or ProblemHttpResult
  /// </summary>
  public static Results<Ok<TResponse>, ValidationProblem, NotFound, ProblemHttpResult> ToOkWithNotFoundResult<TValue, TResponse>(
    this Result<TValue> result,
    Func<TValue, TResponse> mapResponse)
  {
    return result.Status switch
  ...
  /// <summary>
  /// Maps Result to TypedResults for Delete/Update endpoints that return NoContent, ValidationProblem, NotFound, or ProblemHttpResult
  /// </summary>
  public static Results<NoContent, ValidationProblem, NotFound, ProblemHttpResult> ToNoContentResult(
    this Result result)
  {
    return result.Status switch
    {
  ...
  /// <summary>
  /// Maps Result to TypedResults for Move endpoints that return Ok, NotFound, or ProblemHttpResult
  /// </summary>
  public static Results<Ok, NotFound, ProblemHttpResult> ToMoveResult<TValue>(
    this Result<TValue> result)
  {
    return result.Status switch
    {
